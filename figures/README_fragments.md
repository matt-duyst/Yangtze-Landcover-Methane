...
76<!--#pipeline.recipes--> registered regeneration recipes,
41<!--#pipeline.recipes_committed--> rebuild their artefact from what a fresh
clone holds, 24<!--#pipeline.recipes_local--> need a fetched input and
10<!--#pipeline.recipes_network--> need a network run.
