...
65<!--#pipeline.recipes--> registered regeneration recipes,
37<!--#pipeline.recipes_committed--> rebuild their artefact from what a fresh
clone holds, 18<!--#pipeline.recipes_local--> need a fetched input and
