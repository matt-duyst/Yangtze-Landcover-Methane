...
`notes/references.bib` carries one hundred ninety-seven entries as BibTeX. It is
...
ninety-seven cited DOIs resolved: one hundred seventy-nine through Crossref and
...
negotiation. There are one hundred ninety-seven of them and they are the whole of
